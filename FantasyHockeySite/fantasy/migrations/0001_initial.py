    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goals_weight', models.DecimalField(db_column='Goals_Weight', decimal_places=1, default=3, max_digits=3)),
                ('assists_weight', models.DecimalField(db_column='Assists_Weight', decimal_places=1, default=2, max_digits=3)),
                ('powerplay_goals_weight', models.DecimalField(db_column='Powerplay_Goals_Weight', decimal_places=1, default=1, max_digits=3)),
                ('powerplay_points_weight', models.DecimalField(db_column='Powerplay_Points_Weight', decimal_places=1, default=1, max_digits=3)),
                ('shorthanded_goals_weight', models.DecimalField(db_column='Shorthanded_Goals_Weight', decimal_places=1, default=2, max_digits=3)),
                ('shorthanded_points_weight', models.DecimalField(db_column='Shorthanded_Points_Weight', decimal_places=1, default=1, max_digits=3)),
                ('plus_minus_weight', models.DecimalField(db_column='+/-_Weight', decimal_places=1, default=1, max_digits=3)),
                ('penalty_minutes_weight', models.DecimalField(db_column='Penalty_Minutes_Weight', decimal_places=1, default=0.5, max_digits=3)),
                ('game_winning_goals_weight', models.DecimalField(db_column='Game_Winning_Goals_Weight', decimal_places=1, default=1, max_digits=3)),
                ('shots_on_goal_weight', models.DecimalField(db_column='Shots_on_Goal_Weight', decimal_places=1, default=0.4, max_digits=3)),
                ('wins_weight', models.DecimalField(db_column='Wins_Weight', decimal_places=1, default=4, max_digits=3)),
                ('losses_weight', models.DecimalField(db_column='Losses_Weight', decimal_places=1, default=-2, max_digits=3)),
                ('overtime_losses_weight', models.DecimalField(db_column='Overtime_Losses_Weight', decimal_places=1, default=-2, max_digits=3)),
                ('shots_against_weight', models.DecimalField(db_column='Shots_Against_Weight', decimal_places=1, default=0.2, max_digits=3)),
                ('saves_weight', models.DecimalField(db_column='Saves_Weight', decimal_places=1, default=0.2, max_digits=3)),
                ('goals_against_weight', models.DecimalField(db_column='Goals_Against_Weight', decimal_places=1, default=-1, max_digits=3)),
                ('saves_percentage_weight', models.DecimalField(db_column='Saves_Percentage_Weight', decimal_places=1, default=0, max_digits=3)),
                ('shutouts_weight', models.DecimalField(db_column='Shutouts_Weight', decimal_places=1, default=2, max_digits=3)),
