...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='Fantasy_League_Name', on_delete=django.db.models.deletion.CASCADE, related_name='Goalies_Fantasy_League_Name', to='fantasy.FantasyLeague'),
        ),
        migrations.AddField(
            model_name='goalieteams',
            name='playerid',
